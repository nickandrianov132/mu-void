    ...
    return (
        <div className="vote_container">
            <div className="vote_header_wrapper">
                ...
                <h4 className="vote_h4"> <em className="vote_em"> Wcoins rewards will be available from the day of server launching</em></h4>
            </div>
            {isSuccess &&
            <>
            <VoteItem
            ...
            />
            <VoteItem
                title="Vote on MMOHUB"
                link={`https://mmohub.com/site/1131/vote`}
                img={Images.mmohub}
                coinsDesc="every 24 hours"
            />
            <VoteItem
