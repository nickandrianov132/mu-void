        ...
        <div className="guide_main_container">
            <EventsContainer>
                ...
                <div className="small_event_body">
                    <p className="small_event_p">Moss Gambler is NPC in the Elblend from whom you might get valuable weapons up to powerful super prize weapon. Weapons vary from non excellent plane weapon to excellent weapon up to 3 excellent options. The price of each try to gamble is <em className="em_zen">2 000 000 zen</em>.</p>
